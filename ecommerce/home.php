                ...
                <div class="row">
                    <div class="col-md-6 about-us">
                        ...
                        <ul>
                            ...
                            <li>Bel6ieve Style and Stylist</li>
        ...
        <section id="product">
            <div>
                ...
                <div class="col-md-4 footer-box">
                    <button style="margin-left: 645px ; width: 200px; height: 50px;" onClick="location.href='simple-php-shopping-cart/index.php'" type="button" class="btn btn-primary">SHOP NOW</button>
